  ...
  return (
    <div className="mt-36 relative">
      ...
      <div className="flex justify-center relative">
        <button className=" z-20 text-gray-300 px-6 py-3 rounded-full border border-neutral-900 text-lg  hover:bg-neutral-700 transition flex items-center">
          Load All FAQs <span className="ml-2">▼</span>
        </button>

        <div className="absolute z-10 bottom-0 left-0 w-full h-72 bg-gradient-to-t from-black via-black/80 to-transparent pointer-events-none"></div>
